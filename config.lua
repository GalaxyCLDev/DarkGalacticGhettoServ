...
maxPlayers = 0
serverName = "DarkGalaxyGhettoServ"
serverMotd = "Welcome to the DarkGalaxyGhettoServ!"
...
ownerName = "Leon Zavalza"
ownerEmail = "LeonZavalza@outlook.com"
url = "https://LeonZavalza.com/"
location = "Mexico"
